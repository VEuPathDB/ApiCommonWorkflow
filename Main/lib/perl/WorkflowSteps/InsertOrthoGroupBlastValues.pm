...
sub run {
    ...
    my $args = " --groupBlastValuesFile=$workflowDataDir/$groupBlastValuesFile --outputBlastValuesDatFile $workflowDataDir/$groupBlastValuesFile/../../temp.dat --gusConfigFile $gusConfigFile";
