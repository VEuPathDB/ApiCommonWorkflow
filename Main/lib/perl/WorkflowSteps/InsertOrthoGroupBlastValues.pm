...
sub run {
    ...
    my $args = " --groupBlastValuesFile $workflowDataDir/$groupBlastValuesFile --outputBlastValuesDatFile $workflowDataDir/OrthoMCL/peripheralGroups/analysisDir/temp.dat --gusConfigFile $gusConfigFile";
