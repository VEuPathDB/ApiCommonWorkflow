package ApiCommonWorkflow::Main::WorkflowSteps::MakeMbioDerivedTables;
...
";
 ...
 my $cmd = "tuningManager -instance '$instance' -propFile $stepDir/$xmlConfigFileName -doUpdate -notifyEmail none -configFile ${gusHome}/lib/xml/tuningManager/microbiomeTuningManager.xml  " ;
