package ApiCommonWorkflow::Main::WorkflowSteps::LoadAttributesFromEntityGraph;
...
sub run {
    ...
    $self->runPlugin($test, $undo, "ApiCommonData::Load::Plugin::LoadAttributesFromEntityGraph", join(" ", @args));
}
1;
