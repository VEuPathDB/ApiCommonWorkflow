package ApiCommonWorkflow::Main::WorkflowSteps::MakeCuratedGafDownloadFile;
...
sub getWebsiteFileCmd {
    ...
    return "makeCuratedGafFile4Download.pl --organismAbbrev $organismAbbrev --outputFile $downloadFileName";
}
