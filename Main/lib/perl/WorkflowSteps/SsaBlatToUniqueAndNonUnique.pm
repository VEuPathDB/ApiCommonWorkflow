...
sub run {
    ...
    my $cmd = "parse_blat_out.pl $workflowDataDir/$shortSeqsFile $workflowDataDir/$blatFile $workflowDataDir/$mdustFile $workflowDataDir/$uFile $workflowDataDir/$nuFile $chipseqFlag";
